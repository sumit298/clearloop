          ...
          <div className="w-full max-w-95">
            <div>
              ...
              <p className="mt-2 text-[15px] text-text-dim">
                Create your account to start tracking context
              </p>
            </div>
          ...
          <div className="relative z-10 flex flex-col items-center justify-center space-y-8">
            ...
            <div className="flex h-24 w-24 items-center justify-center rounded-2xl border border-primary-soft/20 bg-surface/50 backdrop-blur-xl">
              <svg width="48" height="48" viewBox="0 0 20 20" fill="none">
                <circle cx="10" cy="10" r="8.5" stroke="#B1A3FA" strokeWidth="1.5" />
                <circle cx="10" cy="10" r="5" stroke="#8739D5" strokeWidth="1.5" />
            ...
            <div className="text-center">
              <h2 className="text-2xl font-semibold tracking-tight text-foreground">
                Track work that matters,
                <br />
                with full context.
              </h2>
              <p className="mt-3 text-[14px] text-text-dim">
                Connect features, PRs, and releases in one auditable timeline.
              </p>
            </div>
          </div>
        </div>
